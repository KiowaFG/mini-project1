...
const ApartmentCard = ({apartment, favArray, setFavArray, dataArray}) => {
    ...
    return (
        <div key={apartment.id} className="main-container">
            <img onClick={() => setFavStateFunction(apartment.id)} className="fav-icon" src={favState ? heartFilledIcon : heartIcon}  alt="test" />  {/*{favState ? heartFilledIcon : heartIcon} alt="test" />  */}
