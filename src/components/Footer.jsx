            ...
            <div className="footerMid-container">
                <div className="footerIconLogos-container">
                    <a href="https://www.instagram.com/" target="__blank">
                        <img className="footer-logo instagram" src={instagramLogo} alt="instagram logo" />
                    </a>
                    <p className="logo-separator">/</p>
                    <a href="https://www.facebook.com/" target="__blank">
                        <img className="footer-logo facebook" src={facebookLogo} alt="facebook logo" />
                    </a>
                    <p className="logo-separator">/</p>
                    <a href="https://www.linkedin.com/" target="__blank">
                        <img className="footer-logo linkedin" src={linkedinLogo} alt="linkedin logo" />
                    </a>
                    <p className="logo-separator">/</p>
                    <a href="https://www.youtube.com/" target="__blank">
                        <img className="footer-logo youtube" src={youtubeLogo} alt="youtube logo" />
                    </a>
                    <p className="logo-separator">/</p>
                ...
                <div className="footerLogo-container">
                    <img className="company-logo" src={apartmentsLogo} alt="company logo" />
                </div>
            </div>
